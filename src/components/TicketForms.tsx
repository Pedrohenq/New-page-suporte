  ...
  },
  {
    ...
    fields: [
      ...commonFields,
      {
        ...
        required: true,
        options: [
          "Consultas não foram creditadas",
          "Quantidade de consultas incorreta",
          "Consultas expiraram",
          "Não consigo usar minhas consultas",
          "Consulta foi descontada sem ser realizada",
          "Problema ao comprar pacote de consultas",
          "Dúvida sobre saldo de consultas",
          "Quero transferir consultas para dependente",
          "Consultas não aparecem no app",
          "Outro problema com consultas compradas",
        ],
      },
      {
